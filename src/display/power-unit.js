...
const PowerUnitStatusPacket = require("../packets/power-unit-status-packet");
 ...
 */
const powerUnitEvents = {
  STATUS:'STATUS'
};

class PowerUnit extends EventEmitter {
  ...
  updateStatus = function (buffer, headerLength) {
    ...
    this.emit(powerUnitEvents['STATUS'],{
      detail: {
   ...
   */
  setPowerUnitEnabled = function (column, enabled) {
    var payloadSize = 2;
